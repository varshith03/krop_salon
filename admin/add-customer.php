...
$details=$_POST['details'];
    ...
    $query=mysqli_query($con, "insert into  tblcustomers(sid,Name,Email,MobileNumber,Gender,Details) value('$sid','$name','$email','$mobilenum','$gender','$details')");
    if ($query) {
...
<html>
<head>
<title>KROP SALONS | Add Customers</title>
