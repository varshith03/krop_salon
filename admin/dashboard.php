...
<html>
<head>
<title>KROP SALONS OWNER DASHBOARD</title>
			...
			<div class="main-page">
				...
				<div class="row calender widget-shadow">
					...
					<div class="col-md-4 widget">
						<?php $query1=mysqli_query($con,"Select * from tblcustomers where sid= $sid");
...
?>
					...
					<div class="col-md-4 widget states-last">
						<?php $query3=mysqli_query($con,"Select * from tblappointment where Status='1' and sid= $sid");
...
?>
				...
				<div class="row calender widget-shadow">
					<div class="row-one">
					<div class="col-md-4 widget">
						<?php $query4=mysqli_query($con,"Select * from tblappointment where Status='1' and sid= $sid");
