    ...
    <div class="content">
        <div class="container">
			...
			<form method="post">
               ...
               <table class="table table-bordered"> <thead> <tr> <th>#</th>  <th>Salon ID</th><th>Salon Services</th> <th>Description</th> <th>Cost</th><th>Book Appointment</th></tr> </thead> <tbody>
<?php
...
?>
             ...
             <tr> <th scope="row"><?php echo $cnt;?></th><td><?php  echo $row['sid'];?></td> <td><?php  echo $row['ServiceName'];?></td> <td><?php  echo $row['Description'];?></td> <td><?php  echo $row['Cost'];?></td> <td><a href="appointment.php?sid=<?php  echo $row['sid'];?>"><input type="checkbox" name='services[]'value="<?php echo $row['ServiceName'];?>">SELECT</td></a></tr>   <?php 
$cnt=$cnt+1;
}?></tbody> 
<div class="col-md-12">
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-4 col-sm-5 col-md-4 col-xs-12">
                    <a href="cust_login/index.php" class="btn btn-white btn-lg mt20">Login</a>
