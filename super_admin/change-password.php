...
$query=mysqli_query($con,"select ID from super_admin where username='$adminid' and   password='$cpassword'");
$row=mysqli_fetch_array($query);
if($row>0){
$ret=mysqli_query($con,"update super_admin set password='$newpassword' where username='$adminid'");
...
<body class="cbp-spmenu-push">
  ...
  <?php
$adminid=$_SESSION['bpmsaid'];
$ret=mysqli_query($con,"select * from super_admin where ID='$adminid'");
$cnt=1;
